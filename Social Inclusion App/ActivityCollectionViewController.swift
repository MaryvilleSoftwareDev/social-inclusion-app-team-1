...
let instrumentInstructions = [Instructions(title: "Buy an instrument", instructionCode: "Code1", details: "You may want to start with an affordable insrument", image: #imageLiteral(resourceName: "grand-piano"), socialSkill: "Placeholder skill", socialSkillText: "N/a"), Instructions(title: "Find a good instructor", instructionCode: "Code2", details: "If you cannot find an affordable instructor, there are many instrument teaching books for cheap", image: #imageLiteral(resourceName: "grand-piano"), socialSkill: "Placeholder Skill", socialSkillText: "N/a"), Instructions(title: "Begin performing in front of people you know", instructionCode: "Code3", details: "Start with performing in front of those you are closest to before performing to less well-known peers", image: #imageLiteral(resourceName: "grand-piano"), socialSkill: "Placeholder Skill", socialSkillText: "N/a")]

let placeHolderInstructions = [Instructions(title: "", instructionCode: "Code1", details: "", image: #imageLiteral(resourceName: "grand-piano"), socialSkill: "Placeholder Skill", socialSkillText: "N/a")]
